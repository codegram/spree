$j(function() { 
  if ($j('#country_based').attr('checked')) {
    ...
    show_state();
  } else if ($j('#zipcode_based').attr('checked')) {
    show_zipcode();
  } else {        
    show_zone();
  }
  ...
  $j('#zipcode_based').click(function() { show_zipcode();} ); 
})   
...
var show_country = function() {
  ...
  $j('#zone_members').hide();
  $j('#zipcode_members :input').each(function() { $(this).disable(); })
  $j('#zipcode_members').hide();
...
var show_zipcode = function() {
  ...
  $j('#zone_members :input').each(function() { $(this).disable(); })
  $j('#zone_members').hide();
  $j('#zipcode_members :input').each(function() { $(this).enable(); })
  $j('#zipcode_members').show();
};
